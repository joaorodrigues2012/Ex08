...
<title>Bandeiras - Visualizar País</title> 
...
<body>
	  ...
	  <!-- Modal -->
            ...
            <div id="main" class="container">
                <form class="conteudo" action="listar_pais.do" method="post">
                ...
                <div id="bottom" class="row conteudoC" style="margin-left: 30%;">
                    <div class="col-md-12" >
                        <!-- paginação ainda não foi implementada -->
                        <ul class="pagination">
                            <li class="disabled"><a>&lt; Anterior</a>
                            </li>
                            <li class="disabled"><a>&nbsp1</a>
                            </li>
                            <li><a href="#" style="color:#dc3545">&nbsp2</a>
                            </li>
                            <li><a href="#" style="color:#dc3545">&nbsp3</a>
                            </li>
                            <li class="next"><a href="#" rel="next" style="color:#dc3545">&nbsp Próximo &gt;</a>
                            </li>
                        </ul>
                        <!-- /.pagination -->
                    </div>
